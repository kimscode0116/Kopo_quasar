<template>
    <div class="q-pb-md">
            <div class="text-h6" align="center" v-if="loginState=='true'">
            ...
            <q-carousel
                ...
                <q-carousel-slide name="style" class="column no-wrap flex-center">
                    ...
                    <div class="q-mb-md text-center">
                        ...
                        <a style="font-size:20px;">It is a good chance
                ...
                <q-carousel-slide name="signIn" class="column no-wrap flex-center">
                    ...
                    <div class="q-mt-md text-center">
                        ...
                        <q-btn
                            ...
                            color="teal-10"
                            type='a'
                            href='/#/myinfo' v-if="loginState=='true'">mypage</q-btn>
